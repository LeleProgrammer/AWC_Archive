...
i32 main() {
    ...
    while (T--) {
        ...
        _rep(i,1,n) {
            if (cur==1 && s[i]=='s') cur++;
            else if (cur==2 && s[i]=='a') cur++;
            else if (cur==3 && s[i]=='y') cur++;
            else if (cur==4 && s[i]=='o') cur++;
            else if (cur==5 && s[i]=='u') cur++;
            else if (cur==6 && s[i]=='n') cur++;
            else if (cur==7 && s[i]=='a') cur++;
            else if (cur==8 && s[i]=='r') cur++;
            else if (cur==9 && s[i]=='a') cur++;
        }
        _Yes(cur==10);
    }
    return 0;
