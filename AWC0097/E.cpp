...
i32 main() {
    ...
    _for(g,vec) {
        int pos=UB(t,g);
        if (pos==t.size()) t.emplace_back(g);
        else t[pos]=g;
    }
    write(vec.size()-t.size()+cnt);
    return 0;
}

/*
100 101 102 [100] 109 [108] [106] 114 [113] 114 114 124 [122] 127 [126] [125] [134] 133 133 134 143 144 144 148 149 158 159 164 169 174
*/